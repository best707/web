var $;!function(){"use strict";function n(t){return t.replace(/\\('|\\)/g,"$1").replace(/[\r\t\n]/g," ")}var t,r={engine:"doT",version:"1.1.1",templateSettings:{evaluate:/\{\{([\s\S]+?(\}?)+)\}\}/g,interpolate:/\{\{=([\s\S]+?)\}\}/g,encode:/\{\{!([\s\S]+?)\}\}/g,use:/\{\{#([\s\S]+?)\}\}/g,useParams:/(^|[^\w$])def(?:\.|\[[\'\"])([\w$\.]+)(?:[\'\"]\])?\s*\:\s*([\w$\.]+|\"[^\"]+\"|\'[^\']+\'|\{[^\}]+\})/g,define:/\{\{##\s*([\w\.$]+)\s*(\:|=)([\s\S]+?)#\}\}/g,defineParams:/^\s*([\w$]+):([\s\S]+)/,conditional:/\{\{\?(\?)?\s*([\s\S]*?)\s*\}\}/g,iterate:/\{\{~\s*(?:\}\}|([\s\S]+?)\s*\:\s*([\w$]+)\s*(?:\:\s*([\w$]+))?\s*\}\})/g,varname:"it",strip:!0,append:!0,selfcontained:!1,doNotSkipEncoded:!1},template:void 0,compile:void 0,log:!0};r.encodeHTMLSource=function(t){var e={"&":"&#38;","<":"&#60;",">":"&#62;",'"':"&#34;","'":"&#39;","/":"&#47;"},a=t?/[&<>"'\/]/g:/&(?!#?\w+;)|<|>|"|'|\//g;return function(t){return t?t.toString().replace(a,function(t){return e[t]||t}):""}},t=function(){return this||(0,eval)("this")}(),"undefined"!=typeof module&&module.exports?module.exports=r:"function"==typeof define&&define.amd?define(function(){return r}):t.doT=r;var o={append:{start:"'+(",end:")+'",startencode:"'+encodeHTML("},split:{start:"';out+=(",end:");out+='",startencode:"';out+=encodeHTML("}},a=/$^/;r.template=function(e,i,l){var s,S,E=(i=i||r.templateSettings).append?o.append:o.split,d=0,c=i.use||i.define?function e(i,l,s){return("string"==typeof l?l:l.toString()).replace(i.define||a,function(e,l,S,E){return 0===l.indexOf("def.")&&(l=l.substring(4)),l in s||(":"===S?(i.defineParams&&E.replace(i.defineParams,function(e,i,S){s[l]={arg:i,text:S}}),l in s||(s[l]=E)):Function("def","def['"+l+"']="+E)(s)),""}).replace(i.use||a,function(l,S){i.useParams&&(S=S.replace(i.useParams,function(e,i,l,S){if(s[l]&&s[l].arg&&S){var E=(l+":"+S).replace(/'|\\/g,"_");return s.__exp=s.__exp||{},s.__exp[E]=s[l].text.replace(RegExp("(^|[^\\w$])"+s[l].arg+"([^\\w$])","g"),"$1"+S+"$2"),i+"def.__exp['"+E+"']"}}));var E=Function("def","return "+S)(s);return E?e(i,E,s):E})}(i,e,l||{}):e;c=("var out='"+(i.strip?c.replace(/(^|\r|\n)\t* +| +\t*(\r|\n|$)/g," ").replace(/\r|\n|\t|\/\*[\s\S]*?\*\//g,""):c).replace(/'|\\/g,"\\$&").replace(i.interpolate||a,function(e,i){return E.start+n(i)+E.end}).replace(i.encode||a,function(e,i){return s=!0,E.startencode+n(i)+E.end}).replace(i.conditional||a,function(e,i,l){return i?l?"';}else if("+n(l)+"){out+='":"';}else{out+='":l?"';if("+n(l)+"){out+='":"';}out+='"}).replace(i.iterate||a,function(e,i,l,s){return i?(d+=1,S=s||"i"+d,"';var arr"+d+"="+(i=n(i))+";if(arr"+d+"){var "+l+","+S+"=-1,l"+d+"=arr"+d+".length-1;while("+S+"<l"+d+"){"+l+"=arr"+d+"["+S+"+=1];out+='"):"';} } out+='"}).replace(i.evaluate||a,function(e,i){return"';"+n(i)+"out+='"})+"';return out;").replace(/\n/g,"\\n").replace(/\t/g,"\\t").replace(/\r/g,"\\r").replace(/(\s|;|\}|^|\{)out\+='';/g,"$1").replace(/\+''/g,""),s&&(i.selfcontained||!t||t._encodeHTML||(t._encodeHTML=r.encodeHTMLSource(i.doNotSkipEncoded)),c="var encodeHTML = typeof _encodeHTML !== 'undefined' ? _encodeHTML : ("+r.encodeHTMLSource.toString()+"("+(i.doNotSkipEncoded||"")+"));"+c);try{return Function(i.varname,c)}catch(p){throw"undefined"!=typeof console&&console.log("Could not create a template function: "+c),p}},r.compile=function(t,e){return r.template(t,null,e)}}();const ALERT={FAIL_RESET:"현재 스탯 초기화를 할 수 없습니다. 잠시 후, 다시 시도해주세요.",FAIL_LOAD_SAVED_STAT:"현재 저장된 스탯 데이터를 가져올 수 없습니다. 잠시 후, 다시 시도해주세요.",CONFIRM_RESET:"초기화를 하면 레벨은 50으로, 입력하신 스탯포인트는 모두 베이스 스탯으로 초기화 됩니다.",CAN_SAVE_STAT_AFTER_LOGIN:"스탯 세팅 저장은 로그인 후 이용 가능합니다.",CAN_MODIFY_STAT_AFTER_LOGIN:"스탯 세팅 수정은 로그인 후 이용 가능합니다.",CAN_DELETE_STAT_AFTER_LOGIN:"스탯 세팅 삭제는 로그인 후 이용 가능합니다.",SAVE_STAT_LIMIT:`스탯 세팅 저장은 계정당 최대 6개까지 가능합니다.
...
보너스 스탯 포인트를 분배하실 수 있습니다.`,REMAIN_STAT_ZERO:"사용하실 수 있는 스탯 포인트를 모두 사용하셨습니다.",IMPOSSIBLE_LEVEL_CONSUME_ELIXIR_STAT:"엘릭서 스탯 포인트를 사용할 수 없는 레벨입니다.",NO_UNDO_STAT:"되돌릴 수 있는 스탯 포인트가 없습니다.",REQUIRE_EXHAUST_STAT:"남은 스탯 포인트를 모두 배분해주세요.",NEED_STAT_POINT:t=>`스탯을 올리려면 최소 ${t.point}포인트가 필요합니다. 
 레벨을 올려 사용 가능 포인트를 모아주세요.`,STAT_MAX_LIMIT:`선택한 스탯을 더 이상 올릴 수 없습니다.
 레벨을 올려 스탯 한계치를 높여주세요.`,DISABLE_LEVELUP:`포인트가 3 이상이면 레벨업이 불가능합니다. 
 
스탯 상승 버튼을 클릭해 포인트를 소모해주세요.`},BREAKPOINTS={tablet:640,pc:960,max:1340},DAYS={Sunday:"일",Monday:"월",Tuesday:"화",Wednesday:"수",Thursday:"목",Friday:"금",Saturday:"토"},API_DOMAIN_DEFAULT="",API_COMMUNITY_DOMAIN="",STATIC_DOMAIN_DEFAULT="",STATIC_CDN_DOMAIN_DEFAULT="",NO_ITEM_IMAGE_URL=`${cdn_url}/img/noimg.gif`,PET_NECKLACE_ID=25668,getLoadingBarTpl=()=>'<div class="loadingbar"></div>',getSectionTpl=()=>`
